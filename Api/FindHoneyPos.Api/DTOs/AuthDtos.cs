...
public record CreateUserRequest(string Username, string Password, string DisplayName, string Role = "PosUser");
...
public record UserInfo(int Id, string Username, string DisplayName, bool IsActive, string Role, DateTime CreatedAt, DateTime? LastLoginAt);
